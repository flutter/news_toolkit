...
Your project includes sample configurations for ads, but does not contain functional placeholder Firebase configuration. You will need to follow the additional configuration steps for Firebase and ads setup:
